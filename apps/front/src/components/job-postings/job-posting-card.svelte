...
<a
    ...
    use:link
    class="bg-white rounded-lg flex shadow-lg relative flex flex-col my-5 mt-2-5
    p-5 pb-2-5 pr-2-5 pt-0 w-full md:max-w-screen-sm max-w-sm md:ml-15"
>

    <div
        class="absolute -top-2-5 left-5 md:top-2-5 md:-left-15 bg-white rounded-lg flex shadow-xl w-15
        h-15 md:w-25 md:h-25 p-2-5 flex flex-row justify-center items-center"
    >
        <img
    ...
    <div class="absolute bg-red-600 w-2-5 h-2-5 m-2-5 top-0 right-0 rounded-full">
    </div>
    <div class="ml-15 md:ml-5 pl-5 h-10 md:h-5 md:mt-5 md:mb-2-5 my-1-25 flex flex-col justify-center">
        <p class="leading-5 font-bold text-lg text-indigo-900 max-h-full truncate-2-lines mr-5">
            {jobPostingTest.hiringOrganization.name}, {jobPostingTest.hiringOrganization.address.addressLocality}
        </p>
    </div>
    <div class="flex flex-col mt-5 mb-2-5 md:ml-5 md:pl-5 md:mt-0 md:mb-2-5">
    ...
    <div class="flex flex-col md:flex-row md:m-0 md:mb-2-5 md:ml-5 md:pl-5 md:items-center">
        ...
        <div class="flex flex-col mb-2-5 md:m-0">
            <p class="text-base text-indigo-900 whitespace-no-wrap">{jobPostingTest.baseSalary}</p>
        </div>
        <div class="h-0-5 w-5 md:hidden bg-gray-200"></div>
    </div>
    <div class="flex flex-row mt-2-5 mb-1-25 md:m-0 md:ml-5 md:pl-5 md:mb-2-5 flex-wrap pr-20">
        <img
    ...
    <div class="flex flex-row absolute right-2-5 bottom-2-5 w-20 justify-end">
