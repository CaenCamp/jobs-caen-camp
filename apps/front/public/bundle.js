...
var app = (function () {
	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				h1 = internal_56("h1");
				t0 = internal_131("Hello ");
				t1 = internal_131(/*name*/ ctx[0]);
				t2 = internal_131("!");
				internal_11(h1, file, 4, 0, 39);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
			m: function mount(target, anchor) {
				internal_81(target, h1, anchor);
				internal_17(h1, t0);
				internal_17(h1, t1);
				internal_17(h1, t2);
			},
			p: function update(ctx, [dirty]) {
				if (dirty & /*name*/ 1) internal_118(t1, /*name*/ ctx[0]);
			},
			i: internal_94,
			o: internal_94,
			d: function destroy(detaching) {
				if (detaching) internal_52(h1);
			}
		};

		internal_54("SvelteRegisterBlock", {
			block,
	...
	class App extends internal_7 {
		constructor(options) {
			super(options);
			internal_79(this, options, instance, create_fragment, internal_106, { name: 0 });

			internal_54("SvelteRegisterComponent", {
				component: this,
				tagName: "App",
				options,
				id: create_fragment.name
